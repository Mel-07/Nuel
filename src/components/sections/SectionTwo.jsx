...
function SectionTwo() {
  ...
  return (
    <div ref={panelTwoRef} className="h-screen  panel-two  panel  backdrop-blur-[1px]  min-w-[100%] grid bg-[#000000]">
      ...
      <div  className=" second-panel-div self-end   w-full  items-center rounded p-2 h-fit  overflow-hidden   bg-black">
        <Marquee pauseOnHover={true} autoFill={true} speed={10} >
          <div className='flex justify-around mx-[1rem]  gap-[2rem]'>
          <div className="bg-white h-[10rem] w-[10rem] md:h-[20rem] md:w-[20rem]  marquee__part  rounded-[1rem] "></div>
          <div className="bg-white h-[10rem] w-[10rem] md:h-[20rem] md:w-[20rem]  marquee__part  rounded-[1rem] "></div>
          <div className="bg-white h-[10rem] w-[10rem] md:h-[20rem] md:w-[20rem]  marquee__part  rounded-[1rem] "></div>
          </div>
        </Marquee>
